/**
 * PURCHASE ORDERS - AUTHENTICATION SYSTEM
 * File: auth.js
 * Purpose: Handle authentication for purchase orders module
 */
...
class AuthManager {
    ...
    isAdmin() {
        const auth = this.getAuthState();
        return auth && (auth.checkLogin === 0 || auth.checkLogin === "0" || auth.roleTemplate === 'admin');
    }
...
console.log("[Purchase Orders] Authentication system loaded");
