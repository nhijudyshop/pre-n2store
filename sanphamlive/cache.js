...
class CacheManager {
    constructor(config = {}) {
        ...
        this.maxAge =
            config.CACHE_EXPIRY ||
            (APP_CONFIG ? APP_CONFIG.CACHE_EXPIRY : 10 * 60 * 1000);
        this.stats = { hits: 0, misses: 0 };
        this.storageKey = config.storageKey || "inventory_persistent_cache";
...
function getCachedData() {
    return cacheManager.get("inventory", "data");
}

function setCachedData(data) {
    cacheManager.set("inventory", data, "data");
    console.log("[CACHE] Inventory data cached successfully");
}
...
// Debug command for checking cache stats
...
console.log("✓ Enhanced Cache Management System loaded");
