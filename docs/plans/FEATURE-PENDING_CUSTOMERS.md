...
const query = `         INSERT INTO pending_customers
...
Frontend 3. orders-report/js/chat/new-messages-notifier.js
...
Kiểm tra database: SELECT _ FROM pending_customers;
